    ...
    <div class="row">
        ...
        <nav class="header-nav-wrap">
            <ul class="header-main-nav">
                ...
                <li><a class="smoothscroll" href="#pricing" title="account type">account type</a></li>
    ...
    <div class="home-content" style="padding-top: 12%">
        ...
        <div class="row home-content__main">
            ...
            <div class="home-content__left">
                <h1>
                    An Amazing way to communicate<br>
                    That Does It All.
                </h1>

                <h3>
                    We pride ourselves on providing the most up-to-date content.
                    Everything you need to create your online classroom and interactive eLearning courses
                </h3>
...
<section id="features" class="s-features target-section">
    ...
    <div class="row features block-1-3 block-m-1-2">
        ...
        <div class="col-block item-feature" data-aos="fade-up">
            ...
            <div class="item-feature__text">
                <h3 class="item-title">exercices</h3>
                <p>we take care af all exercices which teacher send and we save them on independent page , for you don't loose your time going back on old post.
                </p>
            </div>
        </div>
    ...
    <div class="testimonials-wrap" data-aos="fade-up">
        ...
        <div class="row">
            <div class="col-full testimonials-header">
                <h2 class="display-2">Our Users Love Our website!</h2>
            </div>
        </div>
            ...
            <div class="item-plan__block">
                ...
                <div class="item-plan__bottom-part">
                    <ul class="item-plan__features">
                        <li><span>free</span> Storage</li>
                        <li><span>Unlimited</span> messages</li>
                        <li><span>***</span> ***</li>
                        <li>****</li>
                    </ul>
            ...
            <div class="item-plan__block">
                ...
                <div class="item-plan__bottom-part">
                    <ul class="item-plan__features">
                        <li><span>free</span> Storage</li>
                        <li><span>Unlimited</span> messages</li>
                        <li><span>Unlimited</span> groups</li>
                        <li>******</li>
                    </ul>
...
<footer class="s-footer footer">
    ...
    <div class="row footer__bottom">
            ...
            <div class="row">
                ...
                <div class="footer__site-links col-five mob-full">
                    ...
                    <ul class="footer__site-links">
                        ...
                        <li><a href="#pricing" class="smoothscroll">account type</a></li>
                ...
                <div class="footer__contact col-seven mob-full">
                    ...
                    <p>
                        Phone: (+00) 000 0000 <br>
                        Fax: (+00) 000 0000
                    </p>
                    <p>
                        Need help or have a question? Contact us at: <br>
                        <a href="mailto:#0" class="footer__mail-link">support@***.com</a>
                    </p>
                </div>
        ...
        <div class="col-full ss-copyright">
            <span>&copy; Copyright kamal/shakir 2019</span>
            <span>Design by shakir</a></span>
        </div>
