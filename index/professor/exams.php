            ...
            <div class="content">
                <div id="files-container" class="container-fluid">
                    <div id="top-panel" class="top-panel row">
                        <span class="courses_count" style="line-height:40px;font-size:x-large;"><?php echo get_files_count($current_page = get_pageName(), $_SESSION['grp_id']); ?> Exams</span>
                    ...
                    <div id="file_container">
                        <?php 
                            if(isset($_SESSION['grp_id'])){
                                ...
                                $files = load_files_query($_SESSION['grp_id'],'exercice',$current_page);
                                if($files[0] != null){
