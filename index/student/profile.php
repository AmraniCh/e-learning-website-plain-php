                                        ...
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" disabled placeholder="N/A" value="<?php echo $grp_name ?>">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="fname" id="fname" minlength="2" maxlength="20" class="form-control" placeholder="Company" value="<?php echo $fname ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="lname" id="lname" minlength="2" maxlength="20" class="form-control" placeholder="Last Name" value="<?php echo $lname ?>">
                                                    <div class="container" style="padding:0;text-align:left;margin:0;">
                                        ...
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="container" style="padding:0;text-align:left;margin:0;">
                                                        <small id="city_error_msg" class="form-text text-muted"></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="container" style="padding:0;text-align:left;margin:0;">
                                                        <small id="country_error_msg" class="form-text text-muted"></small>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label>Phone</label>
                                                    <input type="text" name="phone" id="phone" class="form-control" placeholder="Phone number" value="<?php echo $tele ?>">
                                                    <div class="container" style="padding:0;text-align:left;margin:0;">
                                                        <small id="phone_error_msg" class="form-text text-muted"></small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <div class="container" style="padding:0;text-align:left;margin:0;">
                                                        <small id="about_error_msg" class="form-text text-muted"></small>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
